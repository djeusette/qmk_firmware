...
led_setup_t leds_white[] = {
    {.hs = 0, .he = 100, .rs = 242, .re = 242, .gs = 243, .ge = 243, .bs = 244, .be = 244, .ef = EF_NONE},
    {.end = 1},
};
...
void *led_setups[] = {leds_blue, leds_white, leds_rainbow_s, leds_rainbow_ns, leds_teal_salmon, leds_yellow, leds_red, leds_green, leds_white_with_red_stripe, leds_black_with_red_stripe, leds_off};
